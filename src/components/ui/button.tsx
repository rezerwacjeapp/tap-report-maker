  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        tile: "border-2 border-tile-border bg-card text-foreground hover:bg-secondary font-medium transition-all",
        tileActive: "border-2 border-tile-active bg-tile-active text-tile-active-foreground font-medium shadow-md animate-tile-pop",
      },
      size: {
