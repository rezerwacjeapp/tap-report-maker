...
export const STARTER_TEMPLATES: ReportTemplate[] = [
  // ===================== 1. HVAC / KLIMATYZACJA =====================
  {
    ...
    fields: [
      { id: "h_legal", label: "Podstawa prawna", type: "heading" as CustomFieldType, remember: false, order: 16 , labelStyle: {"bold":true,"align":"center","color":"#2563eb"}},
      { id: "i_legal", label: "Przepisy", type: "info" as CustomFieldType, remember: false, order: 17, content: "Rozporządzenie PE i Rady (UE) 2024/573 z 7.02.2024 r. w sprawie fluorowanych gazów cieplarnianych.\nUstawa z 15.05.2015 r. o substancjach zubożających warstwę ozonową (Dz.U. z 2020 r. poz. 2065).\nArt. 62 ust. 1 pkt 1 lit. c ustawy Prawo budowlane — kontrola roczna instalacji." , labelStyle: {"bold":true,"color":"#2563eb"}, contentStyle: {"color":"#6b7280","italic":true}},
      { id: "h_client", label: "Dane klienta i obiektu", type: "heading" as CustomFieldType, remember: false, order: 18 , labelStyle: {"bold":true}},
      ...
      { id: "h_device", label: "Dane urządzenia", type: "heading" as CustomFieldType, remember: false, order: 25 , labelStyle: {"bold":true}},
      ...
      { id: "h_fgas", label: "Dane czynnika chłodniczego (F-gaz)", type: "heading" as CustomFieldType, remember: false, order: 28, labelStyle: { bold: true } },
      { id: "i_fgas", label: "Obowiązki F-gaz", type: "info" as CustomFieldType, remember: false, order: 29, content: "Dla urządzeń zawierających ≥5 ton ekwiwalentu CO₂ wymagane jest założenie Karty Urządzenia w CRO i uzupełnianie jej po każdej czynności serwisowej (w ciągu 15 dni roboczych). Protokół przechowywany min. 5 lat." , labelStyle: {"bold":true,"color":"#ea580c"}, contentStyle: {"color":"#ea580c","italic":true}},
      ...
      { id: "h_measurements", label: "Pomiary i kontrola szczelności", type: "heading" as CustomFieldType, remember: false, order: 39 , labelStyle: {"bold":true}},
      ...
      { id: "h_service", label: "Czynności serwisowe", type: "heading" as CustomFieldType, remember: false, order: 47 , labelStyle: {"bold":true}},
      ...
      { id: "h_summary", label: "Podsumowanie i zalecenia", type: "heading" as CustomFieldType, remember: false, order: 49 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
  ...
  // ===================== 2. POMIARY ELEKTRYCZNE =====================
  {
    ...
    fields: [
      { id: "h_legal", label: "Podstawa prawna", type: "heading" as CustomFieldType, remember: false, order: 0 , labelStyle: {"bold":true,"align":"center","color":"#2563eb"}},
      { id: "i_legal", label: "Przepisy", type: "info" as CustomFieldType, remember: false, order: 1, content: "Art. 62 ust. 1 pkt 2 ustawy Prawo budowlane — kontrola co 5 lat.\nPN-HD 60364-6:2016-07 — Sprawdzanie instalacji elektrycznych niskiego napięcia.\nRozporządzenie MSWiA z 16.08.1999 r. (§4–6) — warunki techniczne użytkowania budynków." , labelStyle: {"bold":true,"color":"#2563eb"}, contentStyle: {"color":"#6b7280","italic":true}},
      { id: "h_obj", label: "Dane obiektu i zleceniodawcy", type: "heading" as CustomFieldType, remember: false, order: 2 , labelStyle: {"bold":true}},
      ...
      { id: "h_install", label: "Parametry instalacji", type: "heading" as CustomFieldType, remember: false, order: 12 , labelStyle: {"bold":true}},
      ...
      { id: "h_exec", label: "Dane wykonawcy i przyrządów", type: "heading" as CustomFieldType, remember: false, order: 15 , labelStyle: {"bold":true}},
      { id: "i_meter", label: "Uwaga", type: "info" as CustomFieldType, remember: false, order: 16, content: "Przyrządy pomiarowe muszą posiadać aktualne świadectwa wzorcowania/kalibracji zgodnie z PN-EN 61557. Brak ważnego świadectwa unieważnia protokół." , labelStyle: {"bold":true,"color":"#ea580c"}, contentStyle: {"color":"#ea580c","italic":true}},
      ...
      { id: "h_checks", label: "Wykonane pomiary i oględziny", type: "heading" as CustomFieldType, remember: false, order: 23 , labelStyle: {"bold":true}},
      ...
      { id: "h_results", label: "Wyniki pomiarów", type: "heading" as CustomFieldType, remember: false, order: 25 , labelStyle: {"bold":true}},
      { id: "i_order", label: "Kolejność", type: "info" as CustomFieldType, remember: false, order: 26, content: "Zgodnie z PN-HD 60364-6 pomiary wykonuje się w kolejności: ciągłość PE → rezystancja izolacji → ochrona SELV/PELV → samoczynne wyłączanie → ochrona uzupełniająca → biegunowość → kolejność faz → próby funkcjonalne." , labelStyle: {"bold":true,"color":"#2563eb"}, contentStyle: {"color":"#6b7280","italic":true}},
      ...
      { id: "h_summary", label: "Podsumowanie", type: "heading" as CustomFieldType, remember: false, order: 32 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
  ...
  // ===================== 3. INSTALACJE GAZOWE =====================
  {
    ...
    fields: [
      ...
      { id: "h_exec3", label: "Dane kontrolującego", type: "heading" as CustomFieldType, remember: false, order: 10 , labelStyle: {"bold":true}},
      { id: "i_qualif3", label: "Kwalifikacje", type: "info" as CustomFieldType, remember: false, order: 11, content: "Kontrolę instalacji gazowej może przeprowadzać osoba posiadająca uprawnienia budowlane instalacyjne (sanitarne) lub kwalifikacje dozorowe G3D." , labelStyle: {"bold":true,"color":"#ea580c"}, contentStyle: {"color":"#ea580c","italic":true}},
      ...
      { id: "h_install3", label: "Dane instalacji i urządzeń gazowych", type: "heading" as CustomFieldType, remember: false, order: 15 , labelStyle: {"bold":true}},
      ...
      { id: "h_flue3", label: "Analiza spalin", type: "heading" as CustomFieldType, remember: false, order: 21 , labelStyle: {"bold":true}},
      ...
      { id: "h_vent3", label: "Wentylacja pomieszczeń", type: "heading" as CustomFieldType, remember: false, order: 28 , labelStyle: {"bold":true}},
      ...
      { id: "h_checks3", label: "Czynności kontrolne", type: "heading" as CustomFieldType, remember: false, order: 32 , labelStyle: {"bold":true}},
      ...
      { id: "h_summary3", label: "Ocena i zalecenia", type: "heading" as CustomFieldType, remember: false, order: 34 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
  ...
  // ===================== 4. OCHRONA PPOŻ — GAŚNICE =====================
  {
    ...
    fields: [
      { id: "h_legal4", label: "Podstawa prawna", type: "heading" as CustomFieldType, remember: false, order: 0 , labelStyle: {"bold":true,"align":"center","color":"#2563eb"}},
      { id: "i_legal4", label: "Przepisy", type: "info" as CustomFieldType, remember: false, order: 1, content: "§3 ust. 2–3 Rozporządzenia MSWiA z 7.06.2010 r. — przegląd nie rzadziej niż raz w roku.\nPN-EN 3-7 do PN-EN 3-10 — gaśnice przenośne.\nWymiana środka gaśniczego: proszkowe co 5 lat, śniegowe co 10 lat." , labelStyle: {"bold":true,"color":"#2563eb"}, contentStyle: {"color":"#6b7280","italic":true}},
      { id: "h_obj4", label: "Dane obiektu", type: "heading" as CustomFieldType, remember: false, order: 2 , labelStyle: {"bold":true}},
      { id: "f_protocol_nr", label: "Numer protokołu", type: "text", remember: false, order: 3 },
      { id: "f_client", label: "Zleceniodawca", type: "text", remember: false, order: 4 },
      { id: "f_nip", label: "NIP klienta", type: "text", remember: false, order: 5 },
      { id: "f_address", label: "Adres obiektu", type: "text", remember: false, order: 6 },
      ...
      { id: "h_device4", label: "Dane gaśnicy", type: "heading" as CustomFieldType, remember: false, order: 10 , labelStyle: {"bold":true}},
      ...
      { id: "h_checks4", label: "Czynności kontrolne", type: "heading" as CustomFieldType, remember: false, order: 23 , labelStyle: {"bold":true}},
      ...
      { id: "h_summary4", label: "Ocena i zalecenia", type: "heading" as CustomFieldType, remember: false, order: 25 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
  ...
  // ===================== 5. PPOŻ — HYDRANTY =====================
  {
    ...
    fields: [
      { id: "h_legal5", label: "Podstawa prawna", type: "heading" as CustomFieldType, remember: false, order: 0 , labelStyle: {"bold":true,"align":"center","color":"#2563eb"}},
      { id: "i_legal5", label: "Przepisy i normy", type: "info" as CustomFieldType, remember: false, order: 1, content: "§3 ust. 2–3 Rozporządzenia MSWiA z 7.06.2010 r. — przegląd nie rzadziej niż raz w roku.\nPN-EN 671-1:2012 — hydranty wewnętrzne z wężem półsztywnym.\nPN-EN 671-3:2009 — konserwacja hydrantów.\nMin. ciśnienie dynamiczne: ≥0,2 MPa. Wydajność DN25: ≥1,0 dm³/s, DN52: ≥2,5 dm³/s.\nPróba ciśnieniowa węża: co 5 lat." , labelStyle: {"bold":true,"color":"#2563eb"}, contentStyle: {"color":"#6b7280","italic":true}},
      { id: "h_obj5", label: "Dane obiektu", type: "heading" as CustomFieldType, remember: false, order: 2 , labelStyle: {"bold":true}},
      { id: "f_protocol_nr", label: "Numer protokołu", type: "text", remember: false, order: 3 },
      { id: "f_client", label: "Zleceniodawca", type: "text", remember: false, order: 4 },
      { id: "f_nip", label: "NIP klienta", type: "text", remember: false, order: 5 },
      { id: "f_address", label: "Adres obiektu", type: "text", remember: false, order: 6 },
      ...
      { id: "h_device5", label: "Dane hydrantu", type: "heading" as CustomFieldType, remember: false, order: 10 , labelStyle: {"bold":true}},
      ...
      { id: "h_meas5", label: "Pomiary ciśnienia i wydajności", type: "heading" as CustomFieldType, remember: false, order: 15 , labelStyle: {"bold":true}},
      ...
      { id: "h_checks5", label: "Czynności kontrolne", type: "heading" as CustomFieldType, remember: false, order: 20 , labelStyle: {"bold":true}},
      ...
      { id: "h_summary5", label: "Ocena i zalecenia", type: "heading" as CustomFieldType, remember: false, order: 22 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
  ...
  // ===================== 6. ZDAWCZO-ODBIORCZY =====================
  {
    ...
    fields: [
      ...
      { id: "h_property", label: "Opis lokalu", type: "heading" as CustomFieldType, remember: false, order: 8 , labelStyle: {"bold":true}},
      ...
      { id: "h_meters", label: "Stany liczników", type: "heading" as CustomFieldType, remember: false, order: 14 , labelStyle: {"bold":true}},
      ...
      { id: "h_keys", label: "Klucze i kaucja", type: "heading" as CustomFieldType, remember: false, order: 21 , labelStyle: {"bold":true}},
      ...
      { id: "h_condition", label: "Stan pomieszczeń", type: "heading" as CustomFieldType, remember: false, order: 24 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
      ...
      { id: "h_equip", label: "Wyposażenie i uwagi", type: "heading" as CustomFieldType, remember: false, order: 26 , labelStyle: {"bold":true}},
  ...
  // ===================== 7. WINDY / DŹWIGI =====================
  {
    ...
    fields: [
      { id: "h_legal7", label: "Podstawa prawna", type: "heading" as CustomFieldType, remember: false, order: 0 , labelStyle: {"bold":true,"align":"center","color":"#2563eb"}},
      { id: "i_legal7", label: "Przepisy", type: "info" as CustomFieldType, remember: false, order: 1, content: "Ustawa z 21.12.2000 r. o dozorze technicznym (Dz.U. z 2023 r. poz. 1622).\nRozporządzenie MG z 18.07.2001 r. w sprawie eksploatacji urządzeń technicznych.\nPN-EN 13015 — konserwacja dźwigów i schodów ruchomych." , labelStyle: {"bold":true,"color":"#2563eb"}, contentStyle: {"color":"#6b7280","italic":true}},
      { id: "h_obj7", label: "Dane obiektu", type: "heading" as CustomFieldType, remember: false, order: 2 , labelStyle: {"bold":true}},
      { id: "f_protocol_nr", label: "Numer protokołu", type: "text", remember: false, order: 3 },
      ...
      { id: "h_device7", label: "Dane dźwigu", type: "heading" as CustomFieldType, remember: false, order: 9 , labelStyle: {"bold":true}},
      ...
      { id: "h_exec7", label: "Dane konserwatora", type: "heading" as CustomFieldType, remember: false, order: 18 , labelStyle: {"bold":true}},
      ...
      { id: "h_checks7", label: "Czynności konserwacyjne", type: "heading" as CustomFieldType, remember: false, order: 22 , labelStyle: {"bold":true}},
      ...
      { id: "h_summary7", label: "Ocena i zalecenia", type: "heading" as CustomFieldType, remember: false, order: 24 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
  ...
  // ===================== 8. HYDRAULIKA / CO =====================
  {
    ...
    fields: [
      { id: "h_legal8", label: "Podstawa prawna", type: "heading" as CustomFieldType, remember: false, order: 0 , labelStyle: {"bold":true,"align":"center","color":"#2563eb"}},
      { id: "i_legal8", label: "Przepisy", type: "info" as CustomFieldType, remember: false, order: 1, content: "Art. 62 ust. 1 pkt 1 lit. c ustawy Prawo budowlane — coroczna kontrola instalacji gazowej (kocioł jako element instalacji).\nRozporządzenie MI z 12.04.2002 r. — §132–139 instalacje ogrzewcze, §156–179 instalacje gazowe.\nPN-EN 15378:2017 — inspekcje systemów ogrzewczych." , labelStyle: {"bold":true,"color":"#2563eb"}, contentStyle: {"color":"#6b7280","italic":true}},
      { id: "i_notice8", label: "Uwaga", type: "info" as CustomFieldType, remember: false, order: 2, content: "Przegląd serwisowy kotła i kontrola instalacji gazowej (art. 62 PB) to dwa odrębne obowiązki — jeden nie zastępuje drugiego." , labelStyle: {"bold":true,"color":"#ea580c"}, contentStyle: {"color":"#ea580c","italic":true}},
      { id: "h_obj8", label: "Dane obiektu i zleceniodawcy", type: "heading" as CustomFieldType, remember: false, order: 3 , labelStyle: {"bold":true}},
      ...
      { id: "h_boiler8", label: "Dane kotła", type: "heading" as CustomFieldType, remember: false, order: 12 , labelStyle: {"bold":true}},
      ...
      { id: "h_params8", label: "Parametry pracy", type: "heading" as CustomFieldType, remember: false, order: 18 , labelStyle: {"bold":true}},
      ...
      { id: "h_flue8", label: "Analiza spalin", type: "heading" as CustomFieldType, remember: false, order: 22 , labelStyle: {"bold":true}},
      ...
      { id: "h_service8", label: "Czynności serwisowe", type: "heading" as CustomFieldType, remember: false, order: 28 , labelStyle: {"bold":true}},
      ...
      { id: "h_summary8", label: "Ocena i zalecenia", type: "heading" as CustomFieldType, remember: false, order: 30 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
  ...
  // ===================== 9. FOTOWOLTAIKA =====================
  {
    ...
    fields: [
      { id: "h_legal9", label: "Podstawa prawna", type: "heading" as CustomFieldType, remember: false, order: 0 , labelStyle: {"bold":true,"align":"center","color":"#2563eb"}},
      { id: "i_legal9", label: "Przepisy i normy", type: "info" as CustomFieldType, remember: false, order: 1, content: "Art. 62 ust. 1 pkt 2 ustawy Prawo budowlane — kontrola instalacji elektrycznej co 5 lat.\nPN-EN 62446-1:2016 — systemy PV: wymagania dotyczące badań i dokumentacji.\nPN-HD 60364-7-712:2016 — instalacje fotowoltaiczne.\nInstalacja PV >6,5 kW wymaga uzgodnienia z rzeczoznawcą ppoż." , labelStyle: {"bold":true,"color":"#2563eb"}, contentStyle: {"color":"#6b7280","italic":true}},
      { id: "h_obj9", label: "Dane obiektu i właściciela", type: "heading" as CustomFieldType, remember: false, order: 2 , labelStyle: {"bold":true}},
      { id: "f_protocol_nr", label: "Numer protokołu", type: "text", remember: false, order: 3 },
      ...
      { id: "h_system9", label: "Dane instalacji PV", type: "heading" as CustomFieldType, remember: false, order: 10 , labelStyle: {"bold":true}},
      ...
      { id: "h_cond9", label: "Warunki i przyrządy pomiarowe", type: "heading" as CustomFieldType, remember: false, order: 18 , labelStyle: {"bold":true}},
      ...
      { id: "h_dc9", label: "Pomiary strony DC", type: "heading" as CustomFieldType, remember: false, order: 25 , labelStyle: {"bold":true}},
      ...
      { id: "h_checks9", label: "Czynności kontrolne", type: "heading" as CustomFieldType, remember: false, order: 29 , labelStyle: {"bold":true}},
      ...
      { id: "h_summary9", label: "Ocena i zalecenia", type: "heading" as CustomFieldType, remember: false, order: 31 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
      ...
      { id: "i_insurance9", label: "Informacja", type: "info" as CustomFieldType, remember: false, order: 35, content: "Brak aktualnych protokołów przeglądowych może skutkować odmową wypłaty odszkodowania przez ubezpieczyciela." , labelStyle: {"bold":true,"color":"#ea580c"}, contentStyle: {"color":"#ea580c","italic":true}},
  ...
  // ===================== 10. WENTYLACJA MECHANICZNA =====================
  {
    ...
    fields: [
      { id: "h_legal10", label: "Podstawa prawna", type: "heading" as CustomFieldType, remember: false, order: 0 , labelStyle: {"bold":true,"align":"center","color":"#2563eb"}},
      { id: "i_legal10", label: "Przepisy i normy", type: "info" as CustomFieldType, remember: false, order: 1, content: "Art. 62 ust. 1 pkt 1 lit. c ustawy Prawo budowlane — coroczna kontrola instalacji wentylacyjnej.\nPN-EN 15780:2011 — czystość systemów wentylacyjnych.\nPN-EN 12599 — sprawdzanie instalacji wentylacji.\nRozporządzenie MSWiA z 7.06.2010 r. (§34) — częstotliwość czyszczenia przewodów." , labelStyle: {"bold":true,"color":"#2563eb"}, contentStyle: {"color":"#6b7280","italic":true}},
      { id: "h_obj10", label: "Dane obiektu", type: "heading" as CustomFieldType, remember: false, order: 2 , labelStyle: {"bold":true}},
      { id: "f_protocol_nr", label: "Numer protokołu", type: "text", remember: false, order: 3 },
      { id: "f_client", label: "Właściciel / zarządca", type: "text", remember: false, order: 4 },
      { id: "f_nip", label: "NIP klienta", type: "text", remember: false, order: 5 },
      { id: "f_address", label: "Adres obiektu", type: "text", remember: false, order: 6 },
      ...
      { id: "h_device10", label: "Dane centrali wentylacyjnej", type: "heading" as CustomFieldType, remember: false, order: 11 , labelStyle: {"bold":true}},
      ...
      { id: "h_meas10", label: "Pomiary powietrza", type: "heading" as CustomFieldType, remember: false, order: 15 , labelStyle: {"bold":true}},
      ...
      { id: "h_checks10", label: "Czynności kontrolne", type: "heading" as CustomFieldType, remember: false, order: 26 , labelStyle: {"bold":true}},
      ...
      { id: "h_results10", label: "Wyniki szczegółowe", type: "heading" as CustomFieldType, remember: false, order: 28 , labelStyle: {"bold":true}},
      ...
      { id: "h_summary10", label: "Ocena i zalecenia", type: "heading" as CustomFieldType, remember: false, order: 30 , labelStyle: {"bold":true,"align":"center","color":"#ea580c"}},
